...
import { z } from "zod";
import { Loader2, Phone, User, Calendar, CreditCard, FileText, Shield, CheckCircle, Clock, XCircle, LogIn } from "lucide-react";
...
interface DriverLoginSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function DriverLoginSheet({ open, onOpenChange }: DriverLoginSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={(isOpen) => {
      onOpenChange(isOpen);
      if (!isOpen) {
        setTimeout(resetSheet, 300);
      }
    }}>
      <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Driver Portal</SheetTitle>
          <SheetDescription>
            {isDriverLoggedIn ? "Manage your driver account" : "Login or register as a driver"}
          </SheetDescription>
        </SheetHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  {driver.verificationStatus === "approved" && (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 text-center animate-bounce-in">
                      ...
                      <Button 
                        className="mt-4 gradient-success border-0 shadow-lg hover-elevate w-full" 
                        onClick={() => {
                          onOpenChange(false);
                          navigate("/driver");
                        }}
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} placeholder="Enter 10-digit mobile number" className="pl-10" maxLength={10} />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
              ...
              <CardContent>
                <Form {...registerForm}>
                  <form onSubmit={registerForm.handleSubmit(handleRegister)} className="space-y-4">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                              <Input {...field} placeholder="Enter your mobile number" className="pl-10" disabled />
                            </div>
                          </FormControl>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} type="number" placeholder="Enter your age" className="pl-10" />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} placeholder="12-digit Aadhaar number" className="pl-10" maxLength={12} />
                            </div>
                          </FormControl>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} placeholder="Enter your license number" className="pl-10" />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <Button type="button" variant="outline" className="w-full" onClick={() => setStep("mobile")}>
                      Back to Login
                    </Button>
                  </form>
                </Form>
